<script lang="ts">
 ...
 import { LayoutDashboard, Columns3, Layers, Monitor, Cable, Plug, Plus, Search, Menu, X, ChevronRight, Settings2, ShieldCheck, Github, Command, Cpu, GitBranch } from '@lucide/svelte';
