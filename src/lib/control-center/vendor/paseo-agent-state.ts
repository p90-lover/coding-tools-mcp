// Adapted from getpaseo/paseo da8c1b5; only type imports localized.
// Copyright (c) 2025-present Mohamed Boudra. Apache-2.0; see third_party/licenses/Paseo-LICENSE.
type AgentLifecycleStatus = "initializing" | "idle" | "running" | "error" | "closed";
type WorkspaceStateBucket = "needs_input" | "failed" | "running" | "attention" | "done";
