...
const PROVIDER_EXECUTION_CATALOG = Object.freeze([
  { id: "codex-oauth", name: "Codex OAuth", protocol: "openai_responses", priority: 100, subagentEnabled: true, paseoEnabled: true, annealEnabled: true },
  { id: "openai-api", name: "OpenAI API", protocol: "openai_responses", priority: 95, subagentEnabled: true, paseoEnabled: true, annealEnabled: true },
