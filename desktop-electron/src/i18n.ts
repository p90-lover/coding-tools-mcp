...
const en = {
  ...
  fiveStackLoopbacks: "In-app five-stack loopbacks",
  fiveStackLoopbacksBody: "CPA :8317, Codex Router :4202, CommandCode :9090 (fallback :3050), Paseo :6768, and Anneal :3000/#/tasks. Start reconnects to bundled in-app ports. No separate download is required.",
  fiveStackStart: "Start",
  fiveStackListening: "Listening",
  fiveStackOffline: "Offline",
  fiveStackFallback: "Listening · fallback :3050",
...
const zh: Record<keyof typeof en, string> = {
  ...
  fiveStackLoopbacks: "应用内五栈 loopback",
  fiveStackLoopbacksBody: "CPA :8317、Codex Router :4202、CommandCode :9090（回退 :3050）、Paseo :6768、Anneal :3000/#/tasks。Start 连接捆绑的本机端口，无需单独下载。",
  fiveStackStart: "启动",
  fiveStackListening: "监听中",
  fiveStackOffline: "离线",
  fiveStackFallback: "监听中 · 回退 :3050",
  refreshTools: "刷新",
  runTool: "运行工具",
  selectWorkspace: "工作区",
  selectTool: "工具",
...
const ja: Record<keyof typeof en, string> = {
  ...
  fiveStackLoopbacks: "アプリ内 five-stack loopback",
  fiveStackLoopbacksBody: "CPA :8317、Codex Router :4202、CommandCode :9090（フォールバック :3050）、Paseo :6768、Anneal :3000/#/tasks。Start は同梱のローカルポートへ接続し、別途ダウンロードは不要です。",
  fiveStackStart: "開始",
  fiveStackListening: "待ち受け中",
  fiveStackOffline: "オフライン",
  fiveStackFallback: "待ち受け中 · フォールバック :3050",
  refreshTools: "更新",
  runTool: "ツールを実行",
