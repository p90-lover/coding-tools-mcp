...
const en = {
  ...
  devConnectorIsolationNotice: "Create a separate connector with the exact DEV name below. Keep Coding Tools Native2 unchanged so production and repository development can run side by side.",
  ...
  connectorMigrationNotice: "Upgrading from Codex Native or Codex Native2? Leave the old connector untouched and create Coding Tools Native2 as a new connector. Do not rename or refresh the legacy connector. Verify runtime rejects a legacy-only setup.",
  ...
  managedControls: "Coding Tools controls",
  runtimeOauth: "OAuth",
  runtimeApi: "API models",
  runtimeTasks: "Tasks",
  runtimeTools: "Instant MCP Tools",
...
const zh: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "请使用下方准确的 DEV 名称新建独立连接器。保留 Coding Tools Native2 不变，让生产使用和仓库开发可以同时运行。",
  ...
  connectorMigrationNotice: "从 Codex Native 或 Codex Native2 升级？请保留旧连接器不变，并新建名为 Coding Tools Native2 的连接器。不要重命名或刷新旧连接器。仅有旧连接器时，运行时验证会明确失败。",
  ...
  networkProxy: "网络代理",
  runtimeOrchestrator: "协调器",
  originalApp: "原始界面",
  managedControls: "Coding Tools 控制",
  runtimeOauth: "OAuth",
  runtimeApi: "API 模型",
  runtimeTasks: "任务",
  runtimeTools: "即时 MCP 工具",
...
const ja: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "下記の正確な DEV 名で個別のコネクタを作成してください。Coding Tools Native2 は変更せず、本番利用とリポジトリ開発を並行して実行できる状態を保ちます。",
  ...
  connectorMigrationNotice: "Codex Native または Codex Native2 からアップグレードする場合は、古いコネクタを変更せず、新しい Coding Tools Native2 コネクタを作成してください。古いコネクタの名前変更や更新は行わないでください。古いコネクタしかない場合、ランタイム検証は明示的に失敗します。",
  ...
  originalApp: "元のアプリ",
  managedControls: "Coding Tools 操作",
  runtimeOauth: "OAuth",
  runtimeApi: "API モデル",
  runtimeTasks: "タスク",
  runtimeTools: "インスタント MCP ツール",
