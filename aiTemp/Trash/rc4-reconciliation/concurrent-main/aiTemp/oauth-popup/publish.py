"""Publish verified rc.3 bytes; do not delete, overwrite a release, or force main."""
...
BRANCH='release/main-extension-0.4.3-rc.3';VERSION='0.4.3-rc.3';TAG='v'+VERSION
...
assert paired_extension['source_commit']=='b0d4db553227fa3c7300050b8edff6e2eb9afee4' and paired_extension['version']=='0.0.7'
...
(assets/'provenance.json').write_text(json.dumps({'version':VERSION,'source_commit':SOURCE,'workflow_run':int(RUN),'preserved_main':BASE,'windows':proof,'browser':browser,'extension':paired_extension,'live_chatgpt_account_verified':False},indent=2)+'\n')
...
release=api('releases',{'tag_name':TAG,'target_commitish':SOURCE,'name':f'Coding Tools MCP {TAG} — OAuth popup and extension compatibility','body':notes,'draft':True,'prerelease':True,'make_latest':'false'})
