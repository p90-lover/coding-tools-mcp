"""Fixture-only additive runtime ACL experiment, not production release evidence."""
import ctypes as c
...
assert os.environ.get('GITHUB_ACTIONS')=='true' and os.environ.get('RUNNER_ENVIRONMENT')=='github-hosted', 'Isolated GitHub-hosted fixture only'
