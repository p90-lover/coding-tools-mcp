...
$installProcess = Invoke-BoundedSilentProcess `
    ...
    -Label 'rc.12 installer'
if ($installProcess.ExitCode -ne 0) { throw "rc.12 installer failed with exit code $($installProcess.ExitCode)" }
...
$msiProcess = Invoke-BoundedSilentProcess `
    ...
    -Label 'rc.12 MSI migration harness'
