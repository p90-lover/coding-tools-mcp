...
with sync_playwright() as p:
    ...
    try:
        ...
        page.get_by_role('heading', name='Task board', exact=True).wait_for()
        page.wait_for_function("document.querySelector('aside.cc-rail').getBoundingClientRect().right <= 1")
        ...
        page.screenshot(path=str(root / 'overview-dark-desktop.png'))
        completed.append('navigation/search and narrow bilingual layout with light/dark themes')
