    ...
    match name {
        "codex_tools_status" => {
            ...
            Ok(tool_ok(
                ...
                "supported_mcp_protocol_versions":crate::mcp::protocol::SUPPORTED,
                "tool_list_changed_notifications":false,
                "catalog_fingerprint":crate::mcp::protocol::catalog_metadata(&registry::list_tools_for_profile(&ctx.tool_profile), &ctx.tool_profile).map_err(|_| WorkspaceError::invalid_argument("Cannot encode tool catalog"))?,
