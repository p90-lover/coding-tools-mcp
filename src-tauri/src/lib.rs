...
use commands::{
    ...
    execution_local_provider, execution_local_read, execution_local_update, five_stack_bootstrap,
    five_stack_copy_cpa_management_key, five_stack_inspect, five_stack_open, five_stack_restart,
    five_stack_snapshot, five_stack_start, five_stack_stop, get_actions_runtime_status,
    ...
    get_workspace_secret, hide_to_tray, install_software, integration_read, list_frp_profiles,
    list_linked_projects, list_software, list_workspaces, open_url, open_workspace_directory,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            five_stack_restart,
            five_stack_open,
            five_stack_copy_cpa_management_key,
            five_stack_bootstrap,
            control_board_read,
            ...
            computer_local_pause,
            computer_local_resume,
            computer_local_stop,
            list_workspaces,
