...
export async function auditOAuthReleaseRepo({ root, expectedVersion, expectedAppId }) {
  const repoRoot = path.resolve(root);
  const [rootPackage, electronPackage, tauriConfig, releaseWorkflow] = await Promise.all([
